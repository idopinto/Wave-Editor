...
# !!!!!!!!!! CHANGE HERE !!!!!!!!!!
REVERSE_FUNC = wave_editor.reverse_audio
SLOW_FUNC = wave_editor.slow_down_audio
FAST_FUNC = wave_editor.accelerate_audio
VOLUME_UP_FUNC = wave_editor.volume_up_audio
VOLUME_DOWN_FUNC = wave_editor.volume_down_audio
BLUR_FUNC = wave_editor.dim_filter_audio
# Turn to False if the above functions get the wav without frame-rate element.
WITH_FRAME_RATE = False
