...
def edit_wave_file():
   ...
   # edited_wave_file_list = copy.deepcopy(wave_file_list)
    ...
    print_menu()
    edited_wave_file_list = [SAMPLE_RATE, [[-32768, -32768], [0, 0], [32767, 32767]]]
    ...
    while user_choice != '8':
        ...
        if user_choice == '1':
            ...
            edited_wave_file_list[1] = reverse_audio(edited_wave_file_list[1])
            print(edited_wave_file_list)

        elif user_choice == '2':
            print(edited_wave_file_list)
            print("______________________________________________________")
            edited_wave_file_list[1] = negative_audio(edited_wave_file_list[1])
            print(edited_wave_file_list)
            ...
            print(edited_wave_file_list)
            print("______________________________________________________")
            edited_wave_file_list[1] = slow_down_audio(edited_wave_file_list[1])
            print(edited_wave_file_list)
